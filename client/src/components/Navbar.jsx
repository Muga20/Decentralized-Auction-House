...
function Navbar() {
  return (
    <div>
    <header
      class="js-page-header page-header--transparent fixed top-0 z-20 w-full bg-white/[.15] backdrop-blur transition-colors"
    >
      <div class="flex items-center px-6 py-6 xl:px-24">
        ...
        <form action="search" class="relative ml-12 mr-8 hidden basis-3/12 lg:block xl:ml-[8%]">
          <input
            type="search"
            class="w-full rounded-2xl border border-none bg-white/[.15] py-3 px-4 pl-10 text-white placeholder-white focus:ring-accent"
            placeholder="Search"
          />
        ...
        >
          ...
          <nav class="navbar w-full">
            <ul class="flex flex-col lg:flex-row">
              <li class="js-nav-dropdown group relative">
                <a
                  href="#"
                  class="dropdown-toggle flex items-center justify-between py-3.5 font-display text-base text-jacarta-700 hover:text-accent dark:text-white lg:px-5 lg:text-white lg:hover:text-white"
                  id="navDropdown-1"
                  aria-expanded="false"
                  role="button"
                ...
                >
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-accent">Home 3</span>
                    </a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    ...
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Crypto Consultant</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">NFT Game</span>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">DAO Platform</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Crypto App</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Crypto Trading</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">ICO Landing</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">NFT Aggregator</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                ...
                >
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Maintenance</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Collections Wide</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Collections</span>
                    </a>
                  </li>
                  <li>
                    <a
              ...
              <li class="group">
                <a
                  href="#"
                  class="flex items-center justify-between py-3.5 font-display text-base text-jacarta-700 hover:text-accent dark:text-white lg:px-5 lg:text-white lg:hover:text-white"
                  >Create</a
                >
              </li>
            </ul>
          ...
          <div class="ml-8 hidden lg:flex xl:ml-12">
            ...
            <a
              href="#"
              class="group flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors hover:bg-accent focus:bg-accent"
              aria-label="wallet"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="js-nav-dropdown group-dropdown relative">
              <button
                class="dropdown-toggle group ml-2 flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors hover:bg-accent focus:bg-accent"
                id="profileDropdown"
                aria-expanded="false"
                data-bs-toggle="dropdown"
                aria-label="profile"
            ...
            <a
              href="#"
              class="js-dark-mode-trigger group ml-2 flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors hover:bg-accent focus:bg-accent"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="24"
                height="24"
                class="dark-mode-light h-4 w-4 fill-white transition-colors group-hover:fill-white group-focus:fill-white dark:hidden"
              >
                <path fill="none" d="M0 0h24v24H0z" />
                <path
              ...
              <svg
                ...
                width="24"
                height="24"
                class="dark-mode-dark hidden h-4 w-4 fill-white transition-colors group-hover:fill-white group-focus:fill-white dark:block"
              >
                <path fill="none" d="M0 0h24v24H0z" />
                <path
        ...
        <div class="ml-auto flex lg:hidden">
          ...
          <button
            class="js-mobile-toggle group ml-2 flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors hover:bg-accent focus:bg-accent"
